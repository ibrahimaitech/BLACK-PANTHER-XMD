...
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "260771298411";
...
module.exports = {
  ...
  caption : process.env.CAPTION || "mal glock 30 🔫🔫" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author : process.env.PACK_AUTHER|| "mal hombre",
  packname: process.env.PACK_NAME || "🔫🔫😑glock",
  botname : process.env.BOT_NAME  || "MAL HOMBRE",
  ownername:process.env.OWNER_NAME|| "MAL HOMBRE",
